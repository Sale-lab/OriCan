...
# Plot
snvs.ori.COSMIC.sim.heatmap <- snvs.ori.COSMIC.sim.mat.melt %>% ggplot(aes(x=X2, y=X1, fill=value)) + geom_tile(color = "white") +
...
NER efficiency is assessed using XR-seq data from Hu et al. GENES & DEVELOPMENT 2015 29:948–960
...
knitr::include_graphics("./Rplots/XRseq.DHS.heatmaps.png")
```
...
knitr::include_graphics("./Rplots/cluster.2.extended.profile.5nt_mod.png")
```
